      ...
      <Main>
        ...
        <Article>
          <section className='flex flex-col gap-14'>
            ...
            <div className="flex flex-col gap-5 md:flex-row items-center ">
              <H2 classList={`${defaultTextProp} text-center w-full md:w-5/12 h-full text-5xl`}>
                Bem Vindos
              </H2>
              <p className={` ${defaultTextProp} sm:w-full md:w-7/12 text-lg`}>
        ...
        <Article classList={`${isDark ? "bg-neutral-900" : "bg-neutral-200"} py-16 md:pt-10 md:pb-0 mb-48`}>
          <section className='flex flex-col gap-8 items-center'>
            ...
            <div ref={ref2} className="flex flex-col md:flex-row md:h-32 gap-12">
              <div className={`${isVisible2 ? "swing-in-top-fwd" : "swing-out-top-fwd"} [animation-duration:_500ms] flex w-64 h-80 flex-col justify-around bg-neutral-50 border-4 border-neutral-100 p-5 rounded-xl`}>
                <H2 classList="text-neutral-950 text-center text-2xl">Lite</H2>
                <ol className='text-teal-600 text-start'>
              ...
              <div className={`${isVisible2 ? "delay-150 swing-in-top-fwd" : "swing-out-top-fwd"} [animation-duration:_500ms] flex w-64 h-80 flex-col justify-around bg-neutral-50 border-4 border-neutral-100 p-5 rounded-xl`}>
              ...
              <div className={`${isVisible2 ? "delay-300 swing-in-top-fwd" : "swing-out-top-fwd"} [animation-duration:_500ms] flex w-64 h-80 flex-col justify-around bg-neutral-50 border-4 border-neutral-100 p-5 rounded-xl`}>
                <H2 classList="text-neutral-950 text-center text-2xl">Lite</H2>
                <ol className='text-teal-600 text-start'>
                  <li>Desenvolvimento Personalizado</li>
                  <li>Monitoramento 24/7</li>
                  <li>Consultoria Avançada em Infraestrutura</li>
                </ol>
                <Link className='text-orange-500 border-2 border-orange-500 hover:bg-orange-500 hover:text-orange-50 p-4 rounded-3xl flex items-center gap-5' to="#coffee-btn">
                  Contratar
                </Link>
        ...
        <section className='flex flex-col gap-8 items-center my-5'>
          <a id="coffee-btn" className='text-orange-500 border-2 border-orange-500 hover:bg-orange-500 hover:text-orange-50 p-4 rounded-3xl flex items-center gap-5'>
        ...
        <Article classList='bg-teal-300 py-16'>
          <section className='flex flex-col gap-8 items-center'>
            ...
            <div ref={ref5} className="flex flex-col md:flex-row md:h-48 items-stretch gap-12">
              <div className={`${isVisible5 ? "delay-100 swing-in-top-fwd" : 'swing-out-left-fwd'} flex w-52 h-52 flex-col justify-center bg-teal-600 p-5 rounded-xl`}>
                <H2 classList="text-teal-50 text-center text-7xl">AVIS</H2>
              </div>
              <div className={`${isVisible5 ? "delay-300 swing-in-top-fwd" : 'swing-out-right-fwd'} flex w-52 h-52 flex-col justify-center bg-teal-600 p-5 rounded-xl`}>
